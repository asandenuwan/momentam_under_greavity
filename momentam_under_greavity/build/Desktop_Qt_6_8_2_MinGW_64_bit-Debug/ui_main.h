...
public:
    ...
    void setupUi(QWidget *app)
    {
        ...
        window_f->setMaximumSize(QSize(1900, 900));
        ...
        gun = new QLabel(playground);
        gun->setObjectName("gun");
        gun->setGeometry(QRect(0, 520, 71, 71));
        gun->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 0);"));
        ball = new QLabel(playground);
        ball->setObjectName("ball");
        ball->setGeometry(QRect(20, 560, 21, 21));
